...
if __name__ == '__main__':
    ...
    parser.add_argument('--augment_type',  type=str, required=True, help="Decide in which dimension (time or freq) you want to train your model")
    parser.add_argument('--augment_method_time',  type=str, required=True, help="The augmentation method for the time dimension")
    parser.add_argument('--augment_method_freq',  type=str, required=True, help="The augmentation method for the frequenz dimension")
    parser.add_argument('--augment_strength',  type=str, required=True, help="How the strength of the augmentation should be")
    ...
    # ------------------------------------------------------------------------------------------------
    # Der Code ist so ausgelegt, dass nur EINES der vorgeschlagenen Pakete für das Training verwendet werden
    # Wenn man das Modell mit mehreren Datasets trainieren möchte, dann muss man den Code selber ergänzen!
    ...
    loss_log = model.fit(
        ...
        n_iters=args.iters,
        augment_type=args.augment_method_time,
        augment_strength =args.augment_strength,
        augment_method_time=args.augment_method_time,
        augment_method_freq=args.augment_method_freq,
        verbose=True
    )
